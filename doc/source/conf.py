...
htmlhelp_basename = 'kingbird-dashboarddoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'kingbird-dashboard.tex',
     u'Kingbird Dashboard Documentation',
...
man_pages = [
    ('index', u'Kingbird Dashboard Documentation',
     'Documentation for the Kingbird Dashboard plugin to the Openstack\
      Dashboard (Horizon)',
     [u'OpenStack'], 1)
]
...
texinfo_documents = [
    ('index', 'Kingbird Dashboard',
     u'Kingbird Dashboard Documentation', u'OpenStack',
     'Kingbird Dashboard',
     'User Interface for Kingbird', 'Miscellaneous'),
]
...
epub_title = u'Kingbird Dashboard'
